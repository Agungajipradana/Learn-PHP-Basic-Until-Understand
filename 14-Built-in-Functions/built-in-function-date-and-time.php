<?php
/*
Fungsi Date and Time pada PHP adalah kumpulan fungsi bawaan yang digunakan untuk menangani operasi terkait tanggal dan waktu. 
Fungsi-fungsi ini memungkinkan kita untuk mendapatkan tanggal dan waktu saat ini, memformat tanggal dan waktu, 
atau melakukan operasi perhitungan dengan tanggal dan waktu.

Fungsi ini sangat berguna untuk berbagai kebutuhan, seperti mencatat log, mengatur batas waktu, 
atau menampilkan waktu dalam aplikasi.
*/
...
echo "Selisih tanggal antara 2024-12-25 dan 2024-11-28: " . $diff->format("%R%a hari") . "\n\n";

/*
9. IntlDateFormatter (Pengganti strftime() untuk format lokal)

    - Memformat tanggal sesuai locale tertentu (contoh: Bahasa Indonesia).
*/
echo "9. IntlDateFormatter : Memformat tanggal sesuai locale tertentu.\n\n";

$formatter = new IntlDateFormatter(
    'id_ID', // Locale
    IntlDateFormatter::FULL, // Format panjang
    IntlDateFormatter::NONE, // Tidak menampilkan waktu
    'Asia/Jakarta', // Zona waktu
    IntlDateFormatter::GREGORIAN
);

echo $formatter->format(new DateTime()) . "\n\n"; // Contoh output: Kamis, 14 Agustus 2025
...
*/
echo "10. gmdate() : Mengembalikan tanggal/waktu dalam zona waktu GMT.\n\n";
...
/*
12. cal_days_in_month()

    - Menghitung jumlah hari dalam bulan tertentu untuk kalender tertentu.
*/
echo "12. cal_days_in_month() : Menghitung jumlah hari dalam bulan tertentu untuk kalender tertentu.\n\n";
